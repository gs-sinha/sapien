...
LDFLAGS := -X github.com/gs-sinha/sapien/internal/cli.Version=$(VERSION) \
           -X github.com/gs-sinha/sapien/internal/cli.Commit=$(COMMIT) \
           -X github.com/gs-sinha/sapien/internal/cli.Date=$(DATE)
