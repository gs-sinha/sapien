...
var routeTable = []routeDef{
	...
	{http.MethodGet, "/v1/workspace/repo", "getWorkspaceRepo", "The workspace's own git repository status", true,
		func(s *Server) http.HandlerFunc { return s.handleWorkspaceRepoStatus }},
	{http.MethodPost, "/v1/workspace/repo/fetch", "fetchWorkspaceRepo", "Fetch the workspace repository (no working-tree change)", true,
		func(s *Server) http.HandlerFunc { return s.handleWorkspaceRepoFetch }},
	{http.MethodPost, "/v1/workspace/repo/pull", "pullWorkspaceRepo", "Fast-forward the workspace repository onto its upstream", true,
		func(s *Server) http.HandlerFunc { return s.handleWorkspaceRepoPull }},
	{http.MethodPost, "/v1/workspace/repo/sync", "syncWorkspaceRepo", "Fetch, then pull the workspace repository when the tree is clean", true,
	...
	{http.MethodPost, "/v1/memories/{id}/move", "moveMemory", "Move a workspace-scope memory's file to another tier: local or workspace", true,
		func(s *Server) http.HandlerFunc { return s.handleMemoryMove }},
	{http.MethodPost, "/v1/memories/{id}/commit", "commitMemory", "Commit a workspace-tier memory's file in the workspace repository", true,
		func(s *Server) http.HandlerFunc { return s.handleMemoryCommit }},
	...
	{http.MethodPost, "/v1/examples/{id}/move", "moveExample", "Move a workspace-scope example's file to another tier: local or workspace", true,
		func(s *Server) http.HandlerFunc { return s.handleExampleMove }},
	{http.MethodPost, "/v1/examples/{id}/commit", "commitExample", "Commit a workspace-tier example's file in the workspace repository", true,
		func(s *Server) http.HandlerFunc { return s.handleExampleCommit }},
