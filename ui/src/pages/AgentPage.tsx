...
// (claude, codex, or opencode, via GET /v1/terminal's allowlist, or a plain
// shell) in a real PTY rendered with xterm.js. Terminal only: the runs
// section is the place to look at a run, so this page does not duplicate it.
// The terminal (state/agentTerminal.ts) is a module-level singleton that
// survives navigating elsewhere in the SPA and back; see ui/README.md
// "Agent pane" for what still ends the session (closing the tab, or an
// explicit Restart).
//
